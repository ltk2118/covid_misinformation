...
**The second part of the repo contains code used for the 2021 AI Modelshare Competition where I used a Tensorflow-BERT model to predict fake COVID tweets with 97.3% accuracy and 97.3% F1 score.**
