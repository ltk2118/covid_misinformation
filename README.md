...
**The second part of the repo contains code used for the [winning entry]([url](https://www.modelshare.ai/notebooks/notebook:235)) to the 2021 AI Modelshare Competition where I used a [Tensorflow-BERT model](https://github.com/ltk2118/covid_misinformation/blob/main/AI_Modelshare_Competition_Code.ipynb) to predict fake COVID tweets with 97.3% accuracy and 97.3% F1 score.**
